        ...
        <Links>
          <ul>
            {state ? (
              <>
                <NavLink
                    style={{ textDecoration: "none", color: "#000",background: "#d3d3d3", fontWeight: "600", fontSize: "1.5rem", margin: "0 1.5rem", padding: "0.3rem 1rem" }}
                    to="/alldata"
                  >
                  All Data
                </NavLink>
              ...
              <>
                ...
                <li>
                  <NavLink className={`${window.location.pathname === "/" ? "active" : ""}`} to="/login">
                    Login
                  </NavLink>
                </li>
              </>
